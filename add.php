...
for ($i=0; $i < $itemCount; $i++){
   ...
   $sql = $dbh->prepare("INSERT INTO `alteregoproductstest` (`id`, `sku`, `matrix_id`, `product_code`, `name`, `description`, `description_html`, `stock_type`, `stock_level`, `price_rrp`, `price_trade`, `categories`, `brand`, `product_range`, `material`, `size`, `height`, `length`, `width`, `weight`, `colour`, `image`, `created_at`, `updated_at`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
   $sql->execute(array(
    $id,
    $sku,
    $matrix_id,
